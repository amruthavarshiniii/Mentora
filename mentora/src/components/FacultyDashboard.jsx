...
export default function FacultyDashboard() {
  ...
  const navItems = [
    { path: '/faculty', label: 'Academic Performance', icon: <LayoutDashboard size={20} /> },
    { path: '/faculty/attendance', label: 'Attendance Monitoring', icon: <Users size={20} /> },
    { path: '/faculty/marks', label: 'Internal Marks Analysis', icon: <LineChart size={20} /> },
  ];
      ...
      <main className="dashboard-content">
        <header className="dashboard-header">
          <h1 className="dashboard-page-title">
            {navItems.find(i => i.path === location.pathname || (location.pathname === '/faculty/' && i.path === '/faculty'))?.label || 'Dashboard'}
          </h1>
